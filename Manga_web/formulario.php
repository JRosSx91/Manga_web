        ...
        <?php
            ...
            if(isset($boto1)){
                ...
                if($edadfinal < 18){
                    ...
                    $conexion = mysqli_connect("192.168.87.30", "jross91", "tsubasasan69") or die("No s'ha pogut establir la conexió amb el servidor.");
                    mysqli_set_charset($conexion, "utf8");
                    mysqli_select_db($conexion, "mangalibre") or die("No s'ha pogut conectar amb la base de dades.");
